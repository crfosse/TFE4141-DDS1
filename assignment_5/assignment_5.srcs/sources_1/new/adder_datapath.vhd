...
entity adder_datapath is
  ...
  architecture rtl of adder_datapath is
    ...
    signal y_nxt: std_logic_vector(127 downto 0);
   -- signal carry_r: std_logic_vector;
  ...
  begin
    ...
    process (y_r, a_r, b_r, output_reg_load) begin
      if(output_reg_load = '1') then
        y_nxt <= y_r(127 downto 32) & (unsigned(y_r(31 downto 0)) + unsigned(data_in(31 downto 0));
      else
