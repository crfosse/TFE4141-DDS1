...
funcp funcTab[3] = {(funcp)execute_10, (funcp)execute_8, (funcp)execute_9};
const int NumRelocateId= 3;

void relocate(char *dp)
{
	iki_relocate(dp, "xsim.dir/test_bench_behav/xsim.reloc",  (void **)funcTab, 3);
	iki_vhdl_file_variable_register(dp + 2504);
	iki_vhdl_file_variable_register(dp + 2560);
