...
HD_PWD='/home/crfosse/dds1/TFE4141-DDS1/rsa/rsa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_datapath.tcl
